Idea 驱动 Junit 插件 Main 方法如下：
代码地址：https://android.googlesource.com/platform/tools/idea/+/e782c57d74000722f9db4c9426317410520670c6/plugins/junit_rt/src/com/intellij/rt/execution/junit/JUnitStarter.java
...
public class JUnitStarter {
    ...
    try {
      ...
      if (ourCommandFileName != null) {
        if (!"none".equals(ourForkMode) || ourWorkingDirs != null && new File(ourWorkingDirs).length() > 0) {
          return JUnitForkedStarter
              .startForkedVMs(ourWorkingDirs, args, isJUnit4, listeners, name, out, err, ourForkMode,
                  ourCommandFileName);
        }
      }
  ...
  public static void printClassesList(List classNames, String packageName, String category, File tempFile)
      throws IOException {
